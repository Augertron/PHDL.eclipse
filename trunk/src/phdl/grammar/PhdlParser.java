// $ANTLR 3.3 Nov 30, 2010 12:50:56 /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/Phdl.g 2012-01-23 10:22:09
...
public class PhdlParser extends Parser {
    ...
    public final PhdlParser.deviceDecl_return deviceDecl() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: pinDecl, attrDecl, IDENT, infoDecl
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final PhdlParser.pinDecl_return pinDecl() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: width, pinList, IDENT, pinType
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt20) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: attrAssign, IDENT, pinAssign, infoDecl, width, IDENT
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: IDENT, portAssign, infoDecl, subAttrAssign, IDENT, width
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final PhdlParser.attrAssign_return attrAssign() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: NEWATTR, STRING, qualifier, IDENT
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final PhdlParser.subAttrAssign_return subAttrAssign() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: NEWATTR, qualifier, IDENT, name, STRING
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final PhdlParser.portAssign_return portAssign() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: qualifier, operand, concat, COMBINE
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
