// $ANTLR 3.3 Nov 30, 2010 12:50:56 /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g 2012-01-23 10:22:12
...
public class PhdlAST extends TreeParser {
    ...
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:669:1: subInstDecl[DesignUnit des] : ^( SUBINST_DECL ( width )? instName= IDENT desName= IDENT ( infoDecl )* ( subAttrAssign )* ( portAssign[des, $instName.text] )* ) ;
    public final void subInstDecl(DesignUnit des) throws RecognitionException {
        ...
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:670:2: ( ^( SUBINST_DECL ( width )? instName= IDENT desName= IDENT ( infoDecl )* ( subAttrAssign )* ( portAssign[des, $instName.text] )* ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:670:4: ^( SUBINST_DECL ( width )? instName= IDENT desName= IDENT ( infoDecl )* ( subAttrAssign )* ( portAssign[des, $instName.text] )* )
            {
            ...
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:727:3: ( subAttrAssign )*
            loop24:
            do {
                int alt24=2;
            ...
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:727:18: ( portAssign[des, $instName.text] )*
            loop25:
            do {
                int alt25=2;
    ...
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:730:1: subAttrAssign : ^( SUBATTR_ASSIGN ( NEWATTR )? ( index )? ( name )* IDENT STRING ) ;
    public final void subAttrAssign() throws RecognitionException {
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:731:2: ( ^( SUBATTR_ASSIGN ( NEWATTR )? ( index )? ( name )* IDENT STRING ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:731:4: ^( SUBATTR_ASSIGN ( NEWATTR )? ( index )? ( name )* IDENT STRING )
            {
            match(input,SUBATTR_ASSIGN,FOLLOW_SUBATTR_ASSIGN_in_subAttrAssign647); 

            match(input, Token.DOWN, null); 
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:731:21: ( NEWATTR )?
            int alt26=2;
            ...
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:731:30: ( index )?
            int alt27=2;
            ...
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:731:37: ( name )*
            loop28:
            do {
                int alt28=2;
            ...
            match(input,IDENT,FOLLOW_IDENT_in_subAttrAssign658); 
            match(input,STRING,FOLLOW_STRING_in_subAttrAssign660); 
    ...
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:734:1: portAssign[DesignUnit des, String subInstName] : ^( PORT_ASSIGN ( COMBINE )? ( index )? operand concat[des] ) ;
    public final void portAssign(DesignUnit des, String subInstName) throws RecognitionException {
        ...
        boolean isCombined = false;
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:736:2: ( ^( PORT_ASSIGN ( COMBINE )? ( index )? operand concat[des] ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:736:4: ^( PORT_ASSIGN ( COMBINE )? ( index )? operand concat[des] )
            {
            match(input,PORT_ASSIGN,FOLLOW_PORT_ASSIGN_in_portAssign681); 

            match(input, Token.DOWN, null); 
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:736:18: ( COMBINE )?
            int alt29=2;
            ...
            switch (alt29) {
                case 1 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:736:19: COMBINE
                    {
            ...
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:736:50: ( index )?
            int alt30=2;
            ...
            pushFollow(FOLLOW_operand_in_portAssign693);
            operand18=operand();

            state._fsp--;

            pushFollow(FOLLOW_concat_in_portAssign695);
            concat19=concat(des);
    ...
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:862:1: connectAssign[DesignUnit des] : ^( CONNECT_ASSIGN operand concat[des] ) ;
    public final void connectAssign(DesignUnit des) throws RecognitionException {
        ...
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:863:2: ( ^( CONNECT_ASSIGN operand concat[des] ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:863:4: ^( CONNECT_ASSIGN operand concat[des] )
            {
            match(input,CONNECT_ASSIGN,FOLLOW_CONNECT_ASSIGN_in_connectAssign718); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_operand_in_connectAssign720);
            operand21=operand();

            state._fsp--;

            pushFollow(FOLLOW_concat_in_connectAssign722);
            concat20=concat(des);
    ...
    // $ANTLR start "concat"
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:900:1: concat[DesignUnit des] returns [List<Connection> cons, boolean isReplicated, boolean isOpen] : ( ^( CONCAT_LIST ( operand )* ) | ^( CONCAT_REPL operand ) | ^( CONCAT_OPEN ) );
    public final PhdlAST.concat_return concat(DesignUnit des) throws RecognitionException {
        ...
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:912:2: ( ^( CONCAT_LIST ( operand )* ) | ^( CONCAT_REPL operand ) | ^( CONCAT_OPEN ) )
            int alt32=3;
            switch ( input.LA(1) ) {
            case CONCAT_LIST:
                {
            ...
            switch (alt32) {
                case 1 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:912:4: ^( CONCAT_LIST ( operand )* )
                    {
                    match(input,CONCAT_LIST,FOLLOW_CONCAT_LIST_in_concat756); 

                    if ( input.LA(1)==Token.DOWN ) {
                        match(input, Token.DOWN, null); 
                        // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:912:18: ( operand )*
                        loop31:
                        do {
                            int alt31=2;
                            ...
                            switch (alt31) {
                        	case 1 :
                        	    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:912:19: operand
                        	    {
                    ...
                    break;
                case 2 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:934:4: ^( CONCAT_REPL operand )
                    {
                    match(input,CONCAT_REPL,FOLLOW_CONCAT_REPL_in_concat779); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_operand_in_concat781);
                    operand23=operand();
                    ...
                    break;
                case 3 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:963:4: ^( CONCAT_OPEN )
                    {
    ...
    // $ANTLR start "operand"
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:966:1: operand returns [CommonTree id, List<Integer> indices] : ^( OPERAND val= IDENT ( index )? ) ;
    public final PhdlAST.operand_return operand() throws RecognitionException {
        ...
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:970:2: ( ^( OPERAND val= IDENT ( index )? ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:970:4: ^( OPERAND val= IDENT ( index )? )
            {
            ...
            retval.id = val;
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:970:38: ( index )?
            int alt33=2;
            ...
            switch (alt33) {
                case 1 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:970:39: index
                    {
    ...
    // $ANTLR start "name"
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:973:1: name returns [CommonTree id, List<Integer> indices] : ^( NAME val= IDENT ( index )? ) ;
    public final PhdlAST.name_return name() throws RecognitionException {
        ...
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:977:2: ( ^( NAME val= IDENT ( index )? ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:977:4: ^( NAME val= IDENT ( index )? )
            {
            ...
            retval.id = val;
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:977:35: ( index )?
            int alt34=2;
            ...
            switch (alt34) {
                case 1 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:977:36: index
                    {
    ...
    // $ANTLR start "index"
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:980:1: index returns [List<Integer> indices] : ( ^( BOUNDS hi= INT lo= INT ) | ^( INDICES (idx= INT )+ ) );
    public final List<Integer> index() throws RecognitionException {
        ...
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:987:2: ( ^( BOUNDS hi= INT lo= INT ) | ^( INDICES (idx= INT )+ ) )
            int alt36=2;
            ...
            switch (alt36) {
                case 1 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:987:4: ^( BOUNDS hi= INT lo= INT )
                    {
                    match(input,BOUNDS,FOLLOW_BOUNDS_in_index890); 

                    match(input, Token.DOWN, null); 
                    hi=(CommonTree)match(input,INT,FOLLOW_INT_in_index894); 
                    lo=(CommonTree)match(input,INT,FOLLOW_INT_in_index898); 
                    ...
                    break;
                case 2 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:997:4: ^( INDICES (idx= INT )+ )
                    {
                    match(input,INDICES,FOLLOW_INDICES_in_index909); 

                    match(input, Token.DOWN, null); 
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:997:14: (idx= INT )+
                    int cnt35=0;
                    loop35:
                    do {
                        int alt35=2;
                        ...
                        switch (alt35) {
                    	case 1 :
                    	    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:997:15: idx= INT
                    	    {
    ...
    // $ANTLR start "width"
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1000:1: width returns [List<Integer> indices] : ^( WIDTH hi= INT lo= INT ) ;
    public final List<Integer> width() throws RecognitionException {
        ...
        indices = new ArrayList<Integer>();
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1002:2: ( ^( WIDTH hi= INT lo= INT ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1002:4: ^( WIDTH hi= INT lo= INT )
            {
            match(input,WIDTH,FOLLOW_WIDTH_in_width940); 

            match(input, Token.DOWN, null); 
            hi=(CommonTree)match(input,INT,FOLLOW_INT_in_width944); 
            lo=(CommonTree)match(input,INT,FOLLOW_INT_in_width948); 
    ...
    // $ANTLR start "pinList"
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1014:1: pinList returns [List<String> list] : ^( PIN_LIST (num1= INT | num2= IDENT | num3= PINNUM )+ ) ;
    public final List<String> pinList() throws RecognitionException {
        ...
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1016:2: ( ^( PIN_LIST (num1= INT | num2= IDENT | num3= PINNUM )+ ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1016:4: ^( PIN_LIST (num1= INT | num2= IDENT | num3= PINNUM )+ )
            {
            match(input,PIN_LIST,FOLLOW_PIN_LIST_in_pinList973); 

            match(input, Token.DOWN, null); 
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1017:2: (num1= INT | num2= IDENT | num3= PINNUM )+
            int cnt37=0;
            loop37:
            do {
                int alt37=4;
                ...
                switch (alt37) {
            	case 1 :
            	    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1017:4: num1= INT
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1018:4: num2= IDENT
            	    {
            	    ...
            	    break;
            	case 3 :
            	    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1019:4: num3= PINNUM
            	    {
    ...
    // $ANTLR start "pinType"
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1023:1: pinType returns [PinType type] : ^( PIN_TYPE ( PIN | INPIN | OUTPIN | IOPIN | PWRPIN | SUPPIN ) ) ;
    public final PinType pinType() throws RecognitionException {
        PinType type = null;

        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1024:2: ( ^( PIN_TYPE ( PIN | INPIN | OUTPIN | IOPIN | PWRPIN | SUPPIN ) ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1024:4: ^( PIN_TYPE ( PIN | INPIN | OUTPIN | IOPIN | PWRPIN | SUPPIN ) )
            {
            match(input,PIN_TYPE,FOLLOW_PIN_TYPE_in_pinType1022); 

            match(input, Token.DOWN, null); 
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1025:2: ( PIN | INPIN | OUTPIN | IOPIN | PWRPIN | SUPPIN )
            int alt38=6;
            switch ( input.LA(1) ) {
            case PIN:
                {
            ...
            switch (alt38) {
                case 1 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1025:4: PIN
                    {
                    ...
                    break;
                case 2 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1026:4: INPIN
                    {
                    ...
                    break;
                case 3 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1027:4: OUTPIN
                    {
                    ...
                    break;
                case 4 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1028:4: IOPIN
                    {
                    ...
                    break;
                case 5 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1029:4: PWRPIN
                    {
                    ...
                    break;
                case 6 :
                    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1030:4: SUPPIN
                    {
    ...
    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1033:1: infoDecl returns [CommonTree info, List<Integer> indices] : ^( INFO_DECL ( index )? (st= STRING )+ ) ;
    public final PhdlAST.infoDecl_return infoDecl() throws RecognitionException {
        ...
        try {
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1034:2: ( ^( INFO_DECL ( index )? (st= STRING )+ ) )
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1034:5: ^( INFO_DECL ( index )? (st= STRING )+ )
            {
            match(input,INFO_DECL,FOLLOW_INFO_DECL_in_infoDecl1086); 

            match(input, Token.DOWN, null); 
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1034:17: ( index )?
            int alt39=2;
            ...
            // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1035:3: (st= STRING )+
            int cnt40=0;
            loop40:
            do {
                int alt40=2;
                ...
                switch (alt40) {
            	case 1 :
            	    // /fpga/fpga1/users/rablack/workspace/PHDL/src/phdl/grammar/PhdlAST.g:1035:4: st= STRING
            	    {
    ...
    public static final BitSet FOLLOW_subAttrAssign_in_subInstDecl628 = new BitSet(new long[]{0x0280000000000008L});
    public static final BitSet FOLLOW_portAssign_in_subInstDecl631 = new BitSet(new long[]{0x0200000000000008L});
    public static final BitSet FOLLOW_SUBATTR_ASSIGN_in_subAttrAssign647 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_NEWATTR_in_subAttrAssign649 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000036L});
    public static final BitSet FOLLOW_index_in_subAttrAssign652 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000030L});
    public static final BitSet FOLLOW_name_in_subAttrAssign655 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000030L});
    public static final BitSet FOLLOW_IDENT_in_subAttrAssign658 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_STRING_in_subAttrAssign660 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PORT_ASSIGN_in_portAssign681 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_COMBINE_in_portAssign684 = new BitSet(new long[]{0x0000000000000000L,0x000000000000000EL});
    public static final BitSet FOLLOW_index_in_portAssign690 = new BitSet(new long[]{0x0000000000000000L,0x000000000000000EL});
    public static final BitSet FOLLOW_operand_in_portAssign693 = new BitSet(new long[]{0x3800000000000000L});
    public static final BitSet FOLLOW_concat_in_portAssign695 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CONNECT_ASSIGN_in_connectAssign718 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_operand_in_connectAssign720 = new BitSet(new long[]{0x3800000000000000L});
    public static final BitSet FOLLOW_concat_in_connectAssign722 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CONCAT_LIST_in_concat756 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_operand_in_concat759 = new BitSet(new long[]{0x0000000000000008L,0x000000000000000EL});
    public static final BitSet FOLLOW_CONCAT_REPL_in_concat779 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_operand_in_concat781 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CONCAT_OPEN_in_concat801 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_OPERAND_in_operand822 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_operand826 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000006L});
    public static final BitSet FOLLOW_index_in_operand831 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_NAME_in_name854 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_IDENT_in_name858 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000006L});
    public static final BitSet FOLLOW_index_in_name863 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_BOUNDS_in_index890 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_INT_in_index894 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000080L});
    public static final BitSet FOLLOW_INT_in_index898 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_INDICES_in_index909 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_INT_in_index914 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000080L});
    public static final BitSet FOLLOW_WIDTH_in_width940 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_INT_in_width944 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000080L});
    public static final BitSet FOLLOW_INT_in_width948 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PIN_LIST_in_pinList973 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_INT_in_pinList980 = new BitSet(new long[]{0x0000000000000008L,0x00000000000001A0L});
    public static final BitSet FOLLOW_IDENT_in_pinList989 = new BitSet(new long[]{0x0000000000000008L,0x00000000000001A0L});
    public static final BitSet FOLLOW_PINNUM_in_pinList998 = new BitSet(new long[]{0x0000000000000008L,0x00000000000001A0L});
    public static final BitSet FOLLOW_PIN_TYPE_in_pinType1022 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_PIN_in_pinType1028 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_INPIN_in_pinType1036 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_OUTPIN_in_pinType1043 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_IOPIN_in_pinType1050 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PWRPIN_in_pinType1057 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_SUPPIN_in_pinType1064 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_INFO_DECL_in_infoDecl1086 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_index_in_infoDecl1088 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000040L});
    public static final BitSet FOLLOW_STRING_in_infoDecl1099 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000040L});
