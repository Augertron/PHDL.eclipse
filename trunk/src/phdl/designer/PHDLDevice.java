...
public class PHDLDevice {
	 ...
	 * Default Constructor.
	 * 
	 * Sets the name, creates an empty attribute set and creates an empty pin
	 * set
	 * 
	 * @param name
	 *            the name of the device
	...
	/**
	 * Adds a new pin vector to the device.
	 * 
	...
	public String toString() {
		...
		Iterator<PHDLAttribute> attributesIterator = attributes.iterator();
