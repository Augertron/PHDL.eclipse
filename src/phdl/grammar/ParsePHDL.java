...
public class ParsePHDL {
	...
	public static boolean unitTest() {
		...
		if ((PinType)object_return != PinType.PIN) {
			success &= TestDriver.displayError(testNum, "PinType", "Incorrect pin type", "PIN", object_return.toString());
		}
		
		object_return = getRuleObject(PhdlAST.PIN_TYPE, "INPIN", null);
		if ((PinType)object_return != PinType.INPIN) {
			success &= TestDriver.displayError(testNum, "PinType", "Incorrect pin type", "INPIN", object_return.toString());
		}
		
		object_return = getRuleObject(PhdlAST.PIN_TYPE, "OUTPIN", null);
		if ((PinType)object_return != PinType.OUTPIN) {
			success &= TestDriver.displayError(testNum, "PinType", "Incorrect pin type", "OUTPIN", object_return.toString());
		}
		
		object_return = getRuleObject(PhdlAST.PIN_TYPE, "IOPIN", null);
		if ((PinType)object_return != PinType.IOPIN) {
			success &= TestDriver.displayError(testNum, "PinType", "Incorrect pin type", "IOPIN", object_return.toString());
		}
		
		object_return = getRuleObject(PhdlAST.PIN_TYPE, "PWRPIN", null);
		if ((PinType)object_return != PinType.PWRPIN) {
			success &= TestDriver.displayError(testNum, "PinType", "Incorrect pin type", "PWRPIN", object_return.toString());
		}
		
		object_return = getRuleObject(PhdlAST.PIN_TYPE, "SUPPIN", null);
		if ((PinType)object_return != PinType.SUPPIN) {
			success &= TestDriver.displayError(testNum, "PinType", "Incorrect pin type", "SUPPIN", object_return.toString());
		}
		...
		if (!TestDriver.isEqual(actual2, expected2)) {
			success &= TestDriver.displayError(testNum, "pinList", "Incorrect List", TestDriver.collToString(expected2), TestDriver.collToString(actual2));
		}
		else if (!TestDriver.sameOrdering(actual2, expected2)) {
			success &= TestDriver.displayError(testNum, "pinList", "Incorrect Ordering", TestDriver.collToString(expected2), TestDriver.collToString(actual2));
		}
		...
		if (!TestDriver.isEqual(actual3, expected3)) {
			success &= TestDriver.displayError(testNum, "width", "Incorrect List", TestDriver.collToString(expected3), TestDriver.collToString(actual3));
		}
		else if (!TestDriver.sameOrdering(actual3, expected3)) {
			success &= TestDriver.displayError(testNum, "width", "Incorrect Ordering", TestDriver.collToString(expected3), TestDriver.collToString(actual3));
		}
		...
		try {
			switch(rule) {
				...
				case PhdlAST.INFO_DECL:
					...
					break;
				default: System.err.println("Invalid Rule to Test");
			}
